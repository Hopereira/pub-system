    ...
    const defaultPlans: Partial<Plan>[] = [
      {
        ...
        priceMonthly: 0,
        priceYearly: 0,
        features: ['pedidos', 'comandas', 'mesas', 'produtos', 'funcionarios', 'cardapio_digital'],
      ...
      },
      {
        ...
        priceMonthly: 99,
        priceYearly: 990,
        features: ['pedidos', 'comandas', 'mesas', 'produtos', 'funcionarios', 'cardapio_digital', 'clientes', 'avaliacoes', 'eventos', 'pontos_entrega', 'turnos'],
      ...
      },
      {
        ...
        priceMonthly: 199,
        priceYearly: 1990,
        features: ['pedidos', 'comandas', 'mesas', 'produtos', 'funcionarios', 'cardapio_digital', 'clientes', 'avaliacoes', 'eventos', 'pontos_entrega', 'turnos', 'analytics', 'relatorios_avancados', 'medalhas', 'caixa_avancado'],
