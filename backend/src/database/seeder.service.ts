...
import {
  Ambiente,
  TipoAmbiente,
} from '../modulos/ambiente/entities/ambiente.entity';
  ...
  async seed() {
    ...
    const produtos = [
      // ===== BAR PRINCIPAL (Bebidas e Drinks) =====
      {
        ...
        descricao: 'Chopp cremoso e refrescante',
        preco: 8.0,
        categoria: 'Bebidas',
        ambiente: bar,
      },
      ...
      },
      {
        ...
        descricao: 'Cachaça, morango, açúcar e gelo',
        preco: 16.0,
        categoria: 'Drinks',
        ambiente: bar,
      },
      ...
      {
        nome: 'Gin Tônica',
        descricao: 'Gin, tônica e limão siciliano',
        preco: 22.0,
        categoria: 'Drinks',
        ambiente: bar,
      },
      ...
      // ===== COZINHA QUENTE (Porções quentes, frituras, grelhados) =====
      {
        ...
        descricao: 'Porção generosa para 2 pessoas',
        preco: 35.0,
        categoria: 'Porções',
        ambiente: cozinhaQuente,
      },
      {
        nome: 'Frango a Passarinho',
        descricao: 'Pedaços de frango fritos com alho e salsinha',
        preco: 40.0,
        categoria: 'Porções',
        ambiente: cozinhaQuente,
      },
      {
        nome: 'Mandioca Frita',
        descricao: 'Acompanha maionese da casa',
        preco: 25.0,
        categoria: 'Porções',
        ambiente: cozinhaQuente,
      },
      ...
      },
      {
        ...
        descricao: 'Pão brioche, blend de 180g, queijo, bacon e salada',
        preco: 42.0,
        categoria: 'Lanches',
        ambiente: cozinhaQuente,
      },
      ...
      },
      {
        ...
        descricao: 'Com legumes e arroz integral',
        preco: 48.0,
        categoria: 'Pratos Principais',
        ambiente: cozinhaQuente,
      },
      {
        nome: 'Batata Rústica',
        descricao: 'Batata em gomos assada',
        preco: 22.0,
        categoria: 'Porções',
        ambiente: cozinhaQuente,
      },
      ...
      {
        nome: 'Tábua de Frios',
        descricao: 'Seleção de queijos e embutidos',
        preco: 55.0,
        categoria: 'Porções',
        ambiente: cozinhaFria,
      },
      {
        nome: 'Salada Caesar',
      ...
      {
        nome: 'Salada Caprese',
        descricao: 'Tomate, mussarela de búfala, manjericão e azeite',
        preco: 35.0,
        categoria: 'Saladas',
        ambiente: cozinhaFria,
      },
      {
        ...
        descricao: 'Lâminas de salmão com alcaparras e molho especial',
        preco: 65.0,
        categoria: 'Entradas',
        ambiente: cozinhaFria,
      },
      {
        nome: 'Sorvete de Creme 3 Bolas',
      ...
      {
        nome: 'Picanha na Brasa 400g',
        descricao: 'Picanha mal passada com alho e sal grosso',
        preco: 110.0,
        categoria: 'Carnes',
      ...
      {
        nome: 'Costela BBQ',
        descricao: 'Costela suína glaceada com molho barbecue',
        preco: 85.0,
        categoria: 'Carnes',
        ambiente: churrasqueira,
      },
      {
        ...
        descricao: 'Linguiça toscana defumada',
        preco: 38.0,
        categoria: 'Carnes',
        ambiente: churrasqueira,
      },
      {
        ...
        descricao: '3 espetos de carne, frango e linguiça',
        preco: 45.0,
        categoria: 'Carnes',
        ambiente: churrasqueira,
      },
      {
        ...
        descricao: 'Acompanha farofa e vinagrete',
        preco: 95.0,
        categoria: 'Carnes',
        ambiente: churrasqueira,
      },
      ...
      },
      {
        ...
        descricao: 'Fatia generosa de torta holandesa',
        preco: 18.0,
        categoria: 'Sobremesas',
        ambiente: confeitaria,
      },
      ...
      },
      {
        ...
        descricao: 'Fatia cremosa com calda',
        preco: 24.0,
        categoria: 'Sobremesas',
        ambiente: confeitaria,
      },
      {
        ...
        descricao: 'Fatia do bolo tradicional',
        preco: 15.0,
        categoria: 'Sobremesas',
        ambiente: confeitaria,
      },
    ...
    this.logger.log(
      '✅ 5 Comandas ABERTAS criadas (4 com mesa + 1 no balcão).',
    );

    this.logger.log('🎉 Seeding concluído com sucesso!');
    this.logger.log(
      '📊 Resumo: 8 ambientes | 22 mesas | 42 produtos | 5 clientes | 5 comandas',
    );
  }
}
