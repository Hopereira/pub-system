...
export class InitialSchema1759508612345 implements MigrationInterface {
  name = 'InitialSchema1759508612345';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."ambientes_tipo_enum" AS ENUM('PREPARO', 'ATENDIMENTO')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."mesas_status_enum" AS ENUM('LIVRE', 'OCUPADA', 'RESERVADA', 'AGUARDANDO_PAGAMENTO')`,
    );
    await queryRunner.query(
      `CREATE TABLE "mesas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "numero" integer NOT NULL, "status" "public"."mesas_status_enum" NOT NULL DEFAULT 'LIVRE', "ambiente_id" uuid, CONSTRAINT "UQ_de482eb027afeca7f01c967e236" UNIQUE ("numero", "ambiente_id"), CONSTRAINT "PK_ccff054bd3dad6539869d03350c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."comandas_status_enum" AS ENUM('ABERTA', 'FECHADA', 'PAGA')`,
    );
    await queryRunner.query(
      `CREATE TABLE "comandas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."comandas_status_enum" NOT NULL DEFAULT 'ABERTA', "mesaId" uuid, "clienteId" uuid, CONSTRAINT "PK_f2a79c4679e1b8f6342d758f964" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."itens_pedido_status_enum" AS ENUM('FEITO', 'EM_PREPARO', 'PRONTO', 'ENTREGUE', 'CANCELADO')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."pedidos_status_enum" AS ENUM('FEITO', 'EM_PREPARO', 'PRONTO', 'ENTREGUE', 'CANCELADO')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "paginas_evento" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "titulo" character varying(100) NOT NULL, "url_imagem" text, "ativa" boolean NOT NULL DEFAULT true, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "atualizado_em" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9cd8a83a55186b10f83ffea76bc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "eventos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "titulo" character varying NOT NULL, "descricao" text, "dataEvento" TIMESTAMP NOT NULL, "urlImagem" character varying, "valor" numeric(10,2) NOT NULL DEFAULT '0', "ativo" boolean NOT NULL DEFAULT true, "criado_em" TIMESTAMP NOT NULL DEFAULT now(), "atualizado_em" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_40d4a3c6a4bfd24280cb97a509e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "produtos" ADD CONSTRAINT "FK_daf6d14dbfbb283e0a7741a3ba0" FOREIGN KEY ("ambienteId") REFERENCES "ambientes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "mesas" ADD CONSTRAINT "FK_12bb24cf56933ea8077059a09d8" FOREIGN KEY ("ambiente_id") REFERENCES "ambientes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "comandas" ADD CONSTRAINT "FK_daefbeebfbc0738515616077aa3" FOREIGN KEY ("mesaId") REFERENCES "mesas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "comandas" ADD CONSTRAINT "FK_7f075e9a5fb43047f0b86c52142" FOREIGN KEY ("clienteId") REFERENCES "clientes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "itens_pedido" ADD CONSTRAINT "FK_ab2b96858c45196d22cce672215" FOREIGN KEY ("pedidoId") REFERENCES "pedidos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "itens_pedido" ADD CONSTRAINT "FK_496c47b9befb817d2595f65a901" FOREIGN KEY ("produtoId") REFERENCES "produtos"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "pedidos" ADD CONSTRAINT "FK_361c6c207367cbe221559bec811" FOREIGN KEY ("comandaId") REFERENCES "comandas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "pedidos" DROP CONSTRAINT "FK_361c6c207367cbe221559bec811"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "comandas" DROP CONSTRAINT "FK_7f075e9a5fb43047f0b86c52142"`,
    );
    await queryRunner.query(
      `ALTER TABLE "comandas" DROP CONSTRAINT "FK_daefbeebfbc0738515616077aa3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "mesas" DROP CONSTRAINT "FK_12bb24cf56933ea8077059a09d8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "produtos" DROP CONSTRAINT "FK_daf6d14dbfbb283e0a7741a3ba0"`,
    );
