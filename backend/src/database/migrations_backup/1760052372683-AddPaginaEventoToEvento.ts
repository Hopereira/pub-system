...
export class AddPaginaEventoToEvento1760052372683
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "eventos" ADD CONSTRAINT "FK_f0449752922ac3048bf729d8615" FOREIGN KEY ("paginaEventoId") REFERENCES "paginas_evento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "eventos" DROP CONSTRAINT "FK_f0449752922ac3048bf729d8615"`,
    );
    await queryRunner.query(`ALTER TABLE "eventos" DROP COLUMN "urlImagem"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "eventos" DROP COLUMN "paginaEventoId"`,
    );
  }
}
