...
// Função de ajuda para agrupar os produtos por categoria
...
export default function CardapioClientPage({ comanda, produtos }: CardapioClientPageProps) {
  // Estado para o carrinho e a folha de carrinho
  ...
  // Função para adicionar ou atualizar a quantidade de um item no carrinho
          ...
          <SheetContent>
            ...
            <div className="py-4 space-y-4">
              {carrinho.length === 0 ? (
                ...
                <>
                  {carrinho.map(item => (
                    <div key={item.produtoId} className="flex items-center justify-between border-b pb-2">
                      <div>
