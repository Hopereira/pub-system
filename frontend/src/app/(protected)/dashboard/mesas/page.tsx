...
// Schema de validação com Zod para o formulário de mesa
...
const MesasPage = () => {
  ...
  const loadData = async () => {
    try {
      setIsLoading(true);
      // Carregamos mesas e ambientes em paralelo para mais performance
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input type="number" placeholder="Ex: 1, 2, 3..." {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl>
                            <SelectTrigger><SelectValue placeholder="Selecione o ambiente da mesa" /></SelectTrigger>
                        </FormControl>
                        <SelectContent>
              ...
              <TableRow key={mesa.id}>
                ...
                <TableCell className="text-right">
                  ...
                  <AlertDialog>
                      ...
                      <AlertDialogContent>
                          <AlertDialogHeader><AlertDialogTitle>Tem a certeza?</AlertDialogTitle><AlertDialogDescription>A ação de apagar a Mesa {mesa.numero} não pode ser desfeita.</AlertDialogDescription></AlertDialogHeader>
                          <AlertDialogFooter>
                              <AlertDialogCancel>Cancelar</AlertDialogCancel>
                              <AlertDialogAction onClick={() => handleDelete(mesa.id)}>Continuar</AlertDialogAction>
                          </AlertDialogFooter>
                      </AlertDialogContent>
                  </AlertDialog>
                </TableCell>
